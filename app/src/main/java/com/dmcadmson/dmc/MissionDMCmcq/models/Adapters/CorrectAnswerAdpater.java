...
//    RadioButton selectedAnswer;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
            if(answers[position].equals(correctAns))
            {
            ...
            {
                holder.co.setText("Your Ans: "+answers[position]+", Correct Ans: "+correctAns);
               // holder.co.setTextColor(Color.RED);
            }

        }
        else
        {
            holder.co.setText("Your Ans: "+"not answered"+", Correct Ans: "+correctAns);
           // holder.co.setTextColor(Color.parseColor("#FF4500"));
        }
